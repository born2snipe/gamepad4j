...
clang -arch x86_64 -framework IOKit -framework CoreFoundation -dynamiclib -o ${TARGET}/libgamepad-jni-wrapper.jnilib -I${OSX_JAVA_HEADERS} -I./include -I${INCLUDE} -isysroot ${OSX_SDK} ${SRC_SHARED}/Gamepad_private.c ${SRC_SHARED}/GamepadJniWrapper.c ${SRC_MAC}/Gamepad_macosx.c 
