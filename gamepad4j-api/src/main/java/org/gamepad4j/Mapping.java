...
//				if(idPart.startsWith("TRIGGER_AXIS")) {
...
//					Log.log(">> add analog stick axis mapping for: " + stickID.name() + " / number: " + code);
...
//	 */
//	public static StickID getMappedStickAxisID(IController controller, int stick) {
